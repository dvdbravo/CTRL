class UmedidasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @umedida.save
        ...
        format.json { render :show, status: :created, location: @umedida }
      else
  ...
  def update
    respond_to do |format|
      if @umedida.update(umedida_params)
        ...
        format.json { render :show, status: :ok, location: @umedida }
      else
  ...
  def destroy
    @umedida.destroy
    respond_to do |format|
      format.html { redirect_to umedidas_url, notice: 'Umedida was successfully destroyed.' }
  ...
  private
    ...
    def umedida_params
      params.require(:umedida).permit(:codigo, :descripcion)
    end
end
