...
class PuestosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create puesto" do
    assert_difference('Puesto.count') do
      post puestos_url, params: { puesto: { descripcion: @puesto.descripcion, puesto: @puesto.puesto } }
    end
  ...
  test "should update puesto" do
    patch puesto_url(@puesto), params: { puesto: { descripcion: @puesto.descripcion, puesto: @puesto.puesto } }
