...
class ParametrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post parametros_url, params: { parametro: { calleynumero: @parametro.calleynumero, ciudadedocp: @parametro.ciudadedocp, correoe: @parametro.correoe, noentrada: @parametro.noentrada, nombre: @parametro.nombre, telefono: @parametro.telefono } }
    end
  ...
  test "should update parametro" do
    patch parametro_url(@parametro), params: { parametro: { calleynumero: @parametro.calleynumero, ciudadedocp: @parametro.ciudadedocp, correoe: @parametro.correoe, noentrada: @parametro.noentrada, nombre: @parametro.nombre, telefono: @parametro.telefono } }
